...
@app.route('/wanmei1/<id>')
def hello_world(id):
    return info_wm(id)


@app.route('/wanmei2/<id>')
def wanmei_guns(id):
    return gunsmoney(id)


@app.route('/wanmei3/<id>')
def wanmei_hot(id):
    return hot_gun(id)


@app.route('/wanmei4/<id>')
def hotmaps(id):
    return hot_map(id)


@app.route('/wanmei5/<id>')
def playgame(id):
    return asyncio.run(get_(id))


@app.route('/wanmei6/<id>')
def money(id):
    return gunMoney(id)


@app.route('/wanmei7/<id>')
def make_eloimg(id):
    return elo_img(id)


@app.route('/wanmei8/<id>')
def info5E(id):
    return data_5E(id)
